...
#local variables  
	...
	#//---------------------------------------------------------------------------------------------------------------------- 
		...
		if ((sig_PCKG_ID == 0x40) or (sig_PCKG_ID == 0x52) or (sig_PCKG_ID == 0xCD) or (sig_PCKG_ID == 0xCE) or (sig_PCKG_ID == 0xCF)):  
			...
			print('bSlot '+str(bSlot))        
			if (bSlot < 4):
				print('Inside if => bSlot '+str(bSlot))
				#// Daten speichern...  
				...
				#//Telegramm zahlen
				bIDTgCnt[bSlot] += 1     
				#print('bIDTgCnt '+str(bIDTgCnt[bSlot]))
...
#*******************************************************************************************************************************************#  
# def fileDataInterpretation() funtion END 
# def WriteToFile() function START
...
def WriteToFile():
	...
	Fwr = open("OutputFile_Daten_FBD-4.txt", "w")  

	Fwr.write("//****************************************************//\n") 
	Fwr.write("Daten FBD_4 \n" )       
	Fwr.write("//****************************************************//\n")  
...
# carmen: {"name": "Package_1_2_Data.py"}
